    ...
    <div class="span4">
        <div class="product">
            <div class="product-img featured">
                <div class="picture">
                    <a href="product.php?idsanpham=<?php echo $row['id_sanpham'] ?>">
                        <img src="admincp/moudules/quanlysanpham/uploadImg/<?php echo $row['hinhanh'] ?>" alt="" width="518" height="358" />
                    </a>
            ...
            <div class="main-titles">
                ...
                <h5 class="no-margin">
                    <a href="product.php?idsanpham=<?php echo $row['id_sanpham'] ?>"><?php echo $row['tensp'] ?></a>
                </h5>
            </div>
